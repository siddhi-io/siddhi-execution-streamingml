...
public abstract class ProcessTask implements Task, Configurable {
    ...
    public ClassOption streamTrainOption = new ClassOption("trainStream", 's',
            "DataStream to learn  from.",
            InstanceStream.class, StreamingClassificationStream.class.getName());

    public ClassOption evaluatorOption = new ClassOption("evaluator", 'e',
            "StreamingClassification performance " + "valuation method.",
    ...
    protected static PerformanceEvaluator getDefaultPerformanceEvaluatorForLearner(
            Learner learner) {

...
//                    switch (count) {
//                        case 1:
//                            Assert.assertArrayEquals(new Double[]{45.9602, 44.4844}, new Object[]{event.getData(0),
//                                    event.getData(1)});
//                            break;
//                        case 2:
//                            Assert.assertArrayEquals(new Double[]{4.6481, 6.0874}, new Object[]{event.getData(0),
//                                    event.getData(1)});
//                            break;
//                        case 3:
//                            Assert.assertArrayEquals(new Double[]{25.2928, 26.4717}, new Object[]{event.getData(0),
//                                    event.getData(1)});
//                            break;
//                    }
//                }
...
//        SiddhiManager siddhiManager = new SiddhiManager();
//        String inputStream = "define stream InputStream (x1 double, x2 double, x3 double, x4 double, x5 double, " +
//                "x6 double, x7 double, x8 double, x9 double, x10 double, timestamp long);";
//
//        String query = (
//                "@info(name = 'query1') " +
//                        "from InputStream#window.length(5)#streamingml:kmeans('model4', 3, 10, 30, 0.3f, x1, x2, " +
//                        "x3, x4, x5, x6, x7, x8, x9, x10) " +
//                        "select closestCentroidCoordinate1, closestCentroidCoordinate2,closestCentroidCoordinate3, " +
//                        "closestCentroidCoordinate4, closestCentroidCoordinate5, closestCentroidCoordinate6, " +
//                        "closestCentroidCoordinate7, closestCentroidCoordinate8, closestCentroidCoordinate9, " +
//                        "closestCentroidCoordinate10 " +
//                        "insert into OutputStream;");
//        SiddhiAppRuntime siddhiAppRuntime = siddhiManager.createSiddhiAppRuntime(inputStream + query);
//
//        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
...
//                    switch (count) {
//                        case 1:
//                            Assert.assertArrayEquals(new Double[]{45.2486, 45.2961, 45.0537, 44.8475, 45.2422,
// 44.4798,
//                                    44.8825, 44.1090, 45.1104, 44.5099}, new Object[]{event.getData(0),
//                                    event.getData(1), event.getData(2), event.getData(3), event.getData(4),
//                                    event.getData(5), event.getData(6), event.getData(7), event.getData(8),
//                                    event.getData(9)});
//                            break;
//                        case 2:
//                            Assert.assertArrayEquals(new Double[]{6.4391, 5.2055, 4.858, 5.0139, 4.9563, 4.953,
// 4.6498,
//                                    6.024, 4.7561, 5.4413}, new Object[]{event.getData(0), event.getData(1),
//                                    event.getData(2), event.getData(3), event.getData(4), event.getData(5),
//                                    event.getData(6), event.getData(7), event.getData(8), event.getData(9)});
//                            break;
//                        case 3:
//                            Assert.assertArrayEquals(new Double[]{24.8115, 25.9062, 25.1077, 26.3784, 26.01,
// 24.2884,
//                                    24.6903, 24.3359, 23.6244, 24.9334}, new Object[]{event.getData(0),
//                                    event.getData(1), event.getData(2), event.getData(3), event.getData(4),
//                                    event.getData(5), event.getData(6), event.getData(7), event.getData(8),
//                                    event.getData(9)});
//                            break;
...
//        siddhiAppRuntime.start();
//        try {
//            inputHandler.send(new Object[]{8.4006, 0.6045, 1.0634, 2.5923, 0.2909, 6.0318, 5.2194, 8.1952, 6.5925,
//                    0.0644});
//            inputHandler.send(new Object[]{25.1833, 26.2168, 23.5599, 29.7557, 29.9423, 25.1303, 26.6528, 21.2207,
//                    21.0566, 28.8507});
//            inputHandler.send(new Object[]{41.5751, 48.3917, 41.3757, 44.3261, 40.2119, 41.1496, 48.6898, 41.583,
//                    46.836, 42.3766});
//            inputHandler.send(new Object[]{6.5068, 2.9903, 9.293, 1.3811, 4.0006, 1.1389, 5.9239, 1.8798, 3.088,
//                    0.6718});
//            inputHandler.send(new Object[]{24.0418, 22.41, 28.9318, 26.9783, 20.3859, 26.8972, 27.7941, 21.8818,
//                    20.3053, 20.9119});
//            inputHandler.send(new Object[]{43.2847, 42.4547, 45.561, 41.3031, 43.7302, 44.7738, 40.2929, 40.5572,
//                    40.7004, 47.9038});
//            inputHandler.send(new Object[]{5.7655, 9.3944, 2.0042, 5.6881, 3.8246, 8.721, 3.2686, 3.6687, 2.9914,
//                    5.9546});
//            inputHandler.send(new Object[]{29.5688, 29.0483, 24.5111, 24.5728, 24.6466, 20.6774, 22.3055, 22.5611,
//                    23.9892, 25.3404});
//            inputHandler.send(new Object[]{44.6656, 41.9337, 46.2645, 47.7455, 44.1161, 42.3892, 43.1119, 49.7757,
//                    40.7597, 40.1814});
//            inputHandler.send(new Object[]{3.6982, 3.0602, 0.0822, 7.3049, 9.407, 8.2044, 7.2494, 9.4857, 7.5458,
//                    7.3018});
//            inputHandler.send(new Object[]{28.3939, 28.174, 29.7013, 26.0018, 24.5075, 23.2057, 21.4671, 23.6484,
//                    21.7164, 20.3571});
//            inputHandler.send(new Object[]{43.1037, 43.3149, 46.3058, 48.6343, 49.5634, 42.2124, 42.9253, 48.4812,
//                    40.3779, 42.9361});
//            inputHandler.send(new Object[]{8.1228, 6.8373, 0.9589, 4.0101, 9.3271, 3.1457, 4.5484, 3.1469, 4.2506,
//                    4.4189});
//            inputHandler.send(new Object[]{20.8421, 25.2925, 24.5996, 24.2815, 28.1304, 27.714, 27.2867, 25.5283,
//                    21.788, 28.8521});
//            inputHandler.send(new Object[]{42.2389, 49.0652, 48.8715, 43.4585, 44.7427, 46.8175, 46.5949, 40.2362,
//                    42.4705, 43.1794});
//            inputHandler.send(new Object[]{1.6499, 1.6105, 2.5832, 9.2161, 9.5054, 1.4102, 3.7265, 6.4077, 9.6987,
//                    6.7666});
//            inputHandler.send(new Object[]{20.3057, 26.6666, 22.0666, 24.6667, 22.8689, 25.1348, 21.5598, 24.7805,
//                    22.1504, 29.8942});
//            inputHandler.send(new Object[]{49.9572, 45.6773, 43.2645, 46.1552, 46.3137, 49.4851, 45.265, 43.8225,
//                    48.2223, 44.9731});
//            inputHandler.send(new Object[]{7.8334, 9.5602, 8.4482, 3.6483, 0.2906, 1.0926, 3.3095, 1.8523, 4.0894,
//                    6.4947});
//            inputHandler.send(new Object[]{25.5494, 25.9623, 20.7722, 27.8391, 28.3965, 20.2748, 20.2401, 29.9752,
//                    20.6588, 25.3466});
//            inputHandler.send(new Object[]{45.8195, 43.2914, 41.5843, 42.3883, 49.1927, 45.1339, 47.6554, 44.1657,
//                    44.8267, 42.2404});
//            inputHandler.send(new Object[]{6.3312, 6.8922, 8.292, 6.6083, 5.8872, 1.9287, 7.1752, 8.5791, 6.2261,
//                    6.461});
//            inputHandler.send(new Object[]{21.6857, 24.8914, 26.8182, 28.1578, 27.898, 29.31, 28.5743, 29.0051,
//                    26.2639, 20.8181});
//            inputHandler.send(new Object[]{49.5384, 41.7407, 44.44, 48.6279, 40.0091, 44.838, 43.7001, 40.2115,
//                    49.7994, 43.4042});
//            inputHandler.send(new Object[]{9.628, 5.2659, 7.89, 0.1343, 1.9687, 9.7142, 2.3588, 9.0443, 1.0967,
//                    9.6459});
//            inputHandler.send(new Object[]{23.777, 29.6507, 25.1962, 29.0858, 29.6105, 21.6832, 22.5473, 21.9967,
//                    29.7306, 28.3137});
//            inputHandler.send(new Object[]{44.2324, 49.7846, 45.7918, 43.9529, 46.2282, 45.4589, 46.5645, 48.7078,
//                    47.3368, 49.6748});
//            inputHandler.send(new Object[]{6.4548, 5.8396, 7.9648, 9.5553, 5.0611, 8.1426, 3.7187, 7.9803, 1.9818,
//                    6.6329});
//            inputHandler.send(new Object[]{28.7674, 20.7496, 24.9205, 22.444, 23.713, 22.8569, 28.4749, 22.761,
//                    28.5845, 20.6494});
//            inputHandler.send(new Object[]{48.0704, 47.3068, 47.0782, 41.8831, 48.3138, 42.5396, 44.0249, 43.5495,
//                    49.7745, 48.2287});
//            inputHandler.send(new Object[]{8.4006, 0.6045, 1.0634, 2.5923, 0.2909, 6.0318, 5.2194, 8.1952, 6.5925,
//                    0.0644});
//            inputHandler.send(new Object[]{25.1833, 26.2168, 23.5599, 29.7557, 29.9423, 25.1303, 26.6528, 21.2207,
...
//    //System should validate that in the InputStream except for attribute_0 and attribute_1 others should be
...
//                AssertJUnit.assertTrue(e.getMessage().contains("modelName has to be a constant., when creating " +
//                        "query query1 in siddhi app"));
//        }
//    }
//
//    @Test
...
//        } catch (Exception e) {
//            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
//            AssertJUnit.assertTrue(e.getMessage().contains("k has to be a constant., when creating query query1 " +
//                    "in siddhi app"));
//        }
//    }
//
...
//        } catch (Exception e) {
//            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
//            AssertJUnit.assertTrue(e.getMessage().contains("Maximum iterations has to be a constant., when " +
//                    "creating query query1 in siddhi app"));
//        }
//    }
//
//    @Test
...
//        } catch (Exception e) {
//            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
//            AssertJUnit.assertTrue(e.getMessage().contains("numberOfEventsToRetrain has to be a constant, when " +
//                    "creating query query1 in siddhi app"));
//        }
//    }
//
...
//        } catch (Exception e) {
//            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
//            AssertJUnit.assertTrue(e.getMessage().contains("Decay rate has to be a constant, when creating query " +
//                    "query1 in siddhi app"));
//        }
//    }
//
//}

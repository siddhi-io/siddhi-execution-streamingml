...
public class PerceptronClassifierStreamProcessorExtensionTestCase {
    ...
    private static final Logger logger = Logger.
            getLogger(PerceptronClassifierStreamProcessorExtensionTestCase.class);
    ...
    private String trainingQuery = ("@info(name = 'query-train') " +
            "from StreamTrain#streamingml:updatePerceptronClassifier" + "('model1', " +
            "attribute_4, 0.1, attribute_0, attribute_1, attribute_2, attribute_3) \n"
    ...
    public void testClassificationStreamProcessorExtension1() throws InterruptedException {
        logger.info("PerceptronClassifierUpdaterStreamProcessorExtension TestCase - " +
        ...
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                .createSiddhiAppRuntime(trainingStream + inStreamDefinition
                        + trainingQuery + query);
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                count++;
                if (count == 1) {
                    AssertJUnit.assertArrayEquals(new Object[]{0.8, 0.67, 0.1, 0.03, true,
                            0.5263760000000001}, inEvents[0].getData());
                } else if (count == 2) {
                    AssertJUnit.assertArrayEquals(new Object[]{0.33, 0.23, 0.632, 0.992, false,
                            0.2779144}, inEvents[0].getData());
                } else if (count == 3) {
                    AssertJUnit.assertArrayEquals(new Object[]{0.8, 0.67, 0.1, 0.03, false,
                            0.333926}, inEvents[0].getData());
                } else if (count == 4) {
                    AssertJUnit.assertArrayEquals(new Object[]{0.33, 0.23, 0.632, 0.992, true,
                            0.5128304}, inEvents[0].getData());
                }
            }
        });
        try {
    ...
    public void testClassificationStreamProcessorExtension2() throws InterruptedException {
        logger.info("PerceptronClassifierUpdaterStreamProcessorExtension TestCase " +
                "- Features are not of type double");
        SiddhiManager siddhiManager = new SiddhiManager();

        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 bool, attribute_4 string );";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('model1', " + "0.0,0.5," +
                " attribute_0, attribute_1, attribute_2, attribute_3) \n"
                + "insert all events into outputStream;");
        ...
        try {
            ...
            AssertJUnit.assertTrue(e.getMessage().contains("model.features in " +
                    "perceptronClassifier should be of type DOUBLE or INT. But there's " +
                    "an attribute called attribute_3 of type BOOL"));
        }
    }
    ...
    public void testClassificationStreamProcessorExtension3() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 bool, attribute_4 string );";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('model1', " + "2,0.5, " +
                "attribute_0, attribute_1, attribute_2, attribute_3) \n"
                + "insert all events into outputStream;");
        ...
        try {
            ...
            logger.error(e);
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            AssertJUnit.assertTrue(e.getMessage().contains("Invalid parameter type " +
                    "found for the model.bias argument" +
    ...
    public void testClassificationStreamProcessorExtension4() throws InterruptedException {
        logger.info("PerceptronClassifierUpdaterStreamProcessorExtension TestCase " +
                "- threshold is not double");
        SiddhiManager siddhiManager = new SiddhiManager();

        String inStreamDefinition = "define stream StreamA (attribute_0 double," +
                " attribute_1 double, attribute_2 double, attribute_3 bool, attribute_4 string );";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('model1', " + "0.0,2, " +
                "attribute_0, attribute_1, attribute_2, attribute_3) \n"
                + "insert all events into outputStream;");
        ...
        try {
            ...
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            AssertJUnit.assertTrue(e.getMessage().contains("Invalid parameter type " +
                    "found for the model.threshold argument. Expected: DOUBLE but found: INT"));
        }
    }
    ...
    public void testClassificationStreamProcessorExtension5() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') " +
                ...
                "0.0,1.1, attribute_0, attribute_1, " +
        ...
        try {
            ...
            logger.error(e);
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            AssertJUnit.assertTrue(e.getMessage().contains("Invalid parameter value found for " +
                    "the model threshold argument. Expected a value between " +
                    "0 & 1, but found: 1.1"));
        }
    }
    ...
    public void testClassificationStreamProcessorExtension6() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double, attribute_4 string );";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier(attribute_4, " + "0.0, 1.1, " +
                "attribute_0, attribute_1, attribute_2, attribute_3) \n" +
                "insert all events into outputStream;");
        ...
        try {
            ...
            logger.error(e);
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            AssertJUnit.assertTrue(e.getMessage().contains("Parameter model.name must be " +
                    "a constant but found " +
    ...
    public void testClassificationStreamProcessorExtension7() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double, attribute_4 string );";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier() \n"
                + "insert all events into outputStream;");
        ...
        siddhiAppRuntime.addCallback("query1",
                new QueryCallback() {
                    ...
                    public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                        ...
                        if (count == 1) {
                            AssertJUnit.assertArrayEquals(new Object[]{0.8, 0.67, 0.1, 0.03, true,
                                    0.5263760000000001}, inEvents[0]
                                    .getData());
                        } else if (count == 2) {
                            AssertJUnit.assertArrayEquals(new Object[]{0.33, 0.23, 0.632, 0.992,
                                    false, 0.2779144}, inEvents[0]
                                    .getData());
                        }
                    }
                });
    ...
    public void testClassificationStreamProcessorExtension9() throws InterruptedException {
        ...
        try {
            SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                    .createSiddhiAppRuntime(trainingStream +
                            inStreamDefinition + trainingQuery + query);
            AssertJUnit.fail();
        } catch (Exception e) {
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            logger.error(e);
            AssertJUnit.assertTrue(e.getMessage().contains("Model [model1] expects 4 features, " +
                    "but the streamingml:perceptronClassifier specifies 3 features"));
        }
    }
    ...
    public void testClassificationStreamProcessorExtension10() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double);";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier(0.2, " + "0.0, " +
                "attribute_0, attribute_1, attribute_2, attribute_3) \n" +
                "insert all events into outputStream;");
    ...
    public void testClassificationStreamProcessorExtension11() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double);";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('m1', " + "0.0, " +
        ...
        try {
            ...
            logger.error(e);
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            AssertJUnit.assertTrue(e.getMessage().contains("Parameter[7] of perceptronClassifier " +
                    "must be an attribute present in the stream, " +
    ...
    public void testClassificationStreamProcessorExtension12() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double);";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('m1', " + "0.0, 0.5, " +
                "attribute_0, attribute_1, attribute_2, attribute_3, 2) \n"
                + "insert all events into outputStream;");
        ...
        try {
            ...
            AssertJUnit.assertTrue(e.getMessage().contains("Invalid number of parameters for " +
                    "streamingml:perceptronClassifier. This Stream Processor requires at " +
                    "most 7 parameters, namely, model.name, model.bias, model.threshold, " +
                    "model.features but found 8 parameters"));
        }
    }
    ...
    public void testClassificationStreamProcessorExtension13() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream StreamA (attribute_0 double, " +
                "attribute_1 double, attribute_2 double, attribute_3 double);";
        String query = ("@info(name = 'query1') " +
                "from StreamA#streamingml:perceptronClassifier('model1', attribute_0, " +
    ...
    public void testClassificationStreamProcessorExtension15() throws InterruptedException {
        ...
        try {
            ...
            AssertJUnit.assertTrue(e instanceof SiddhiAppValidationException);
            logger.error(e);
            AssertJUnit.assertTrue(e.getMessage().contains("Model [model1] expects 3 features, " +
                    "but the streamingml:updatePerceptronClassifier specifies 4 features"));
        }
    }
